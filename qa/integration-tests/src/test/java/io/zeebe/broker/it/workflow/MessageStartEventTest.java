...
public class MessageStartEventTest {
  ...
  @Test
  public void shouldCorrelateMessageIfDeployedBefore() {
    // given
  ...
  @Test
  public void shouldCorrelateMessageAndSetPayload() {
    final DeploymentEvent deploymentEvent =
        clientRule
            .getWorkflowClient()
            .newDeployCommand()
    ...
    final WorkflowInstanceEvent catchEventOccurredEvent =
        eventRecorder.getElementInState("wf", WorkflowInstanceState.ELEMENT_COMPLETED);
    assertThat(catchEventOccurredEvent.getPayloadAsMap()).containsExactly(entry("foo", "bar"));
  }
}
